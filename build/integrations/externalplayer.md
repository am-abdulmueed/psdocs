...
[!badge variant="dark" icon="/static/base.png" text="PluginStream"] → [!badge variant="dark" text="Episode page"] → **Press and hold the epsiode** → [!badge variant="dark" text="play in ABC player"]
...
[!badge variant="dark" icon="/static/base.png" text="PluginStream"] → [!badge variant="dark" icon="/static/gear.png" text="Settings"] → [!badge variant="dark" text="Player"] → [!badge variant="dark" icon="play" text="Preferred video player"] → [!badge variant="dark" text="Choose Your Video player"]
